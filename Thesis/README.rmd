...
Given a series of central bank interest rate. I want to get date of consecutive interest rate changes . 

-  I will create a column that gives either a value of 1 or 0 if there has been a change or not
-  if there has been a change for more than 4 quarters take the date of the start to the end of the period. 
...
regime_return <- function (df, filter_vector, )df %>% 
  ...
  filter(Date %in% sa_rate_high_vol) %>% 
