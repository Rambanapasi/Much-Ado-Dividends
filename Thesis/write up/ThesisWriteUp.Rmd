...
\end{align}
$$
The multifactor approach entails the creation of a factor covariance matrix. This is a short term risk forecast that describes trade off of each common fator within the model. This approach requires periodic return calculation to these exposures. The upshot is that the methodology provides an forecast of each assets specific risk. 
...
```{r Figure2, warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Fig1}", fig.height = 3, fig.width = 6, dev = 'png'}
